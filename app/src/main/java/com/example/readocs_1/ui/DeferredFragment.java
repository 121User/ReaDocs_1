...
import com.example.readocs_1.databinding.FragmentDeferredBinding;

public class DeferredFragment extends TemplateDocumentFragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        FragmentDeferredBinding binding = FragmentDeferredBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        collName = "Отложено"; //Имя коллекции

...
import com.example.readocs_1.databinding.FragmentReadBinding;

import java.util.ArrayList;

public class ReadFragment  extends TemplateDocumentFragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        FragmentReadBinding binding = FragmentReadBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        collName = "Прочитано"; //Имя коллекции

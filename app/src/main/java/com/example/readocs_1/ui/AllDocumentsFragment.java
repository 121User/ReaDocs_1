...
import com.example.readocs_1.PermissionUtils;
import com.example.readocs_1.R;
import com.example.readocs_1.TemplateDocumentFragment;
import com.example.readocs_1.databinding.FragmentAllDocumentsBinding;

public class AllDocumentsFragment extends TemplateDocumentFragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        FragmentAllDocumentsBinding binding = FragmentAllDocumentsBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        collName = "Все документы"; //Имя коллекции
